...
-   a **programming language** (for extending functionality and/or creating web applications)
    ...
    -   the R executable is an **interpreter** which understands and acts upon R code
...
-   Extends the popular markdown format (seen on Wikipedia and GitHub) by enabling the author to include executable code *chunks*
